...
export const animalTypes: Record<string, AnimalType> = {
  ...
  bear: {
    ...
    bestMatch: "🐰 토끼상",
    funMatch: "🐱 고양이상",
    celebrities: ["마동석", "강하늘", "조세호"],
    shortDesc: "포근하고 든든한 인간 비타민",
    tags: ["#인간_비타민", "#포용력_MAX", "#든든"],
  },
  rabbit: {
    id: "rabbit",
    emoji: "🐰",
  ...
  deer: {
    ...
    weaknesses: ["소극성", "경계심", "쉽게 기죽음"],
    bestMatch: "🦊 여우상",
    funMatch: "🐧 펭귄상",
    celebrities: ["윤아", "차은우", "문가영"],
  ...
  dino: {
    ...
    weaknesses: ["엉뚱함", "눈치 없음", "고집"],
    bestMatch: "🐹 햄스터상",
    funMatch: "🐯 호랑이상",
    celebrities: ["이광수", "송강", "류준열"],
    shortDesc: "엉뚱하고 독특한 감성의 순수 인간",
    tags: ["#엉뚱미", "#나만의_세계", "#예측불가"],
  },
  wolf: {
    id: "wolf",
    emoji: "🐺",
  ...
  tiger: {
    ...
    loveStyle: "직진적이고 화끈한 연애! 목표를 정하면 반드시 잡는 타입.",
    strengths: ["자신감", "리더십", "결단력", "열정"],
    weaknesses: ["과신", "성급함", "독선적"],
    bestMatch: "🐺 늑대상",
    funMatch: "🦕 공룡상",
    celebrities: ["손흥민", "이영지", "류현진"],
...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    answers: [
      { text: "바로 표현한다! 화 참는 건 못해 🔥", scores: { tiger: 2, penguin: 1, bear: 1 } },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "맛있는 거 먹으면서 편하게 보기 🍰", scores: { hamster: 2, dino: 1, penguin: 1 } },
